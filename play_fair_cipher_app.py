...
if st.session_state.result:
    ...
    if mode == "encrypt":
        ...
        raw = r["output"]
        display_cipher = " ".join(raw[i:i+5] for i in range(0, len(raw), 5))
        st.metric("Encrypted Text", display_cipher)
        ...
        st.metric("Decrypted Text", cleaned)
        st.caption("⚠️ Padding X's have been automatically removed. If your original message contained real X's, they may be missing.")
